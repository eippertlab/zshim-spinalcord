function results = ZShim_SuppIII_II_II_V(scttemplatepath,rawdatapath,processdatapath,recalculateResults)
...
if recalculateResults
    ...
    for sub = 1:size(subjects,1)
        ...
        fm_type = 'cbsfl_1';
        ZShims_Calculate_FMbasedpicks(fm_type,'cbsfl', {8, 0, 8, '1'});
    ...
    load([processdatapath filesep 'extracted_signal' filesep 'signal_templatespace' filesep 'GroupWhole' ...
        filesep 'ReconstructedSignal' filesep 'FM_fmchange' filesep 'results.mat'])
    
end
results_fmcomparison1 =  ZShims_CalculateResults(no,gre,cbsfl_1,0,1);

results{1,1} = 'results_fmcomparison-against no';
results{1,2} = results_fmcomparison1;


results_fmcomparison2 =  ZShims_CalculateResults(no,gre,manual,0,1);

results{2,1} = 'results_fmcomparison-gre vs manual';
results{2,2} = results_fmcomparison2;

results_fmcomparison3 =  ZShims_CalculateResults(no,cbsfl_1,manual,0,1);
