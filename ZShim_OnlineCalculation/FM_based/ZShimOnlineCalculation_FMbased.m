...
% based on the z-shim reference scan. The output is z-shim indices that
% compensates the field-gradient in z-direction.
...
% To use the code please make sure that FSL and SCT are downloaded and they
